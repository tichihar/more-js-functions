...
function addTheValues(param1, param2) {
    if(isNaN(param1) || isNaN(param2)) {
        ...
        addToPage("Both values are numbers. Added together they equal: " + (parseInt(param1) + parseInt(param2)));
    }
}
...
function drawBox(numRows, numCols, boxChar) {
    ...
    boxChar = boxChar || "X"; // <= if the boxChar is undefined, then the "X" will be assigned to boxChar variable
